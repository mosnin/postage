  ...
  return (
    <>
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1.5 text-sm text-slate-400">Sign in to your PostSyncer account</p>
      </div>
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className={cn(
            "w-full flex items-center justify-center gap-3 rounded-lg border border-white/15 bg-white px-4 py-2.5 text-sm font-medium text-slate-800 shadow-sm transition hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed"
          )}
        >
        ...
        <button
          ...
          disabled={!!oauthLoading || isSubmitting}
          className={cn(
            "w-full flex items-center justify-center gap-3 rounded-lg border border-white/15 bg-slate-800 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-slate-700 disabled:opacity-60 disabled:cursor-not-allowed"
          )}
        >
